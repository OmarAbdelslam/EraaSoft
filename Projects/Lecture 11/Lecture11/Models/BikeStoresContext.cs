...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E275FBFCE36");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B4509C1B78");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB857F03B92A");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229DCED089E");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4B5855FDF");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5E5C023B6");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C2159D4A3");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164A0257255").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3946C2661");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C5EFE3461");
